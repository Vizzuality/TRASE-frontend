...
const state = {
  activeIndex: 0, scrollTop: 0, texts: [{
    ...
    action: {
      text: 'explore the tool', href: '/flows.html'
    }
  }, {
    ...
    action: {
      text: 'explore company commitments', href: '/factsheets.html'
    }
  }, {
    ...
    action: {
      text: 'download trase data', href: '/data.html'
    }
  }], sliders: [{
